  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50 p-4 md:p-6">
      <div className="max-w-5xl mx-auto">
        {/* 返回按钮 */}
        <Link href="/" className="inline-flex items-center gap-2 text-gray-600 hover:text-indigo-600 mb-4 transition-colors">
        ...
        <div className="relative mb-5">
          <div className="absolute right-0 top-0 bottom-0 w-12 bg-gradient-to-l from-indigo-50 via-indigo-50/80 to-transparent pointer-events-none z-10 md:hidden" />
